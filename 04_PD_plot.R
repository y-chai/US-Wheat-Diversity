...
plot.DSW.PD <- ggplot(data=WVA.PD.D.long[Variable %in% c("PD1.a") & !is.na(value)]) + 
...
# Save plot
png("./plot/04_PD1_DSW.png", width = 10, height = 10, units = "in", res= 300)
plot.DSW.PD
dev.off()
...
# Save plot
png("./plot/04_PD1PD2_DSW.png", width = 10, height = 10, units = "in", res= 300)
plot.DSW.PD2
dev.off()
