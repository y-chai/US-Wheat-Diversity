...
#WVA.Winter.panel$class3 <- "Winter"
...
for (wheat.class in c("Spring", "Winter", "Durum")) {
  ...
  # Export data
  save(D_yr.abr, file=paste0("./data_intermediate/PD_", wheat.class, "_by_year_abr_region.RData"))           #Change as need
  write.csv(D_yr.abr[[1]], file=paste0("./data_intermediate/PD0_", wheat.class, "_by_year_abr_region.csv"))  #Change as need
  write.csv(D_yr.abr[[2]], file=paste0("./data_intermediate/PD1_", wheat.class, "_by_year_abr_region.csv"))  #Change as need
  write.csv(D_yr.abr[[3]], file=paste0("./data_intermediate/PD2_", wheat.class, "_by_year_abr_region.csv"))  #Change as need
...
for (wheat.class in c("Spring","Winter", "Durum")) {
  ...
  # Export data
  save(D_st.abr, file=paste0("./data_intermediate/PD_", wheat.class, "_by_state_abr_region.RData"))          #Change as need
  write.csv(D_st.abr[[1]], file=paste0("./data_intermediate/PD0_", wheat.class, "_by_state_abr_region.csv"))  #Change as need
  write.csv(D_st.abr[[2]], file=paste0("./data_intermediate/PD1_", wheat.class, "_by_state_abr_region.csv"))  #Change as need
  write.csv(D_st.abr[[3]], file=paste0("./data_intermediate/PD2_", wheat.class, "_by_state_abr_region.csv"))  #Change as need
